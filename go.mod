...
require (
	...
	github.com/hashicorp/packer-plugin-digitalocean v1.0.4
	github.com/hashicorp/packer-plugin-docker v1.0.3
	github.com/hashicorp/packer-plugin-googlecompute v1.0.11
	...
	github.com/hashicorp/packer-plugin-qemu v1.0.3
